...
$string['email_suffix_desc'] = 'Email suffix for users that are created on the fly';
...
$string['on_the_fly'] = 'Create missing users on the fly';
$string['on_the_fly_desc'] = 'If set, users that are bulkenrolled, but don\'t exist in moodle will be created on the fly';
$string['or'] = 'or';
$string['parameter_empty'] = 'Parameter empty';
...
$string['user_to_be_created'] = "User will be created";
